...
//	
//
//  Source file: /Users/dillon/VerilogWorkspace/CGRAGenerator/hardware/generator_z/jtag/Template/src/digital/cfg_and_dbg.svp
...
//	{ adv_clk=>13, burst_start=>5, bypass=>3, global_reset=>10, nop=>0, rd_TST=>9, rd_rd_delay_reg=>17, read=>2, 
//	  read_data=>6, reset_tile=>11, resume_clk=>14, set_rw_count=>4, stall=>12, sys_clk_on=>15, wr_A050=>7, wr_rd_delay_reg=>16, 
//	  wr_to_TST=>8, write=>1 }
//
...
module cfg_and_dbg_unq1
  (
   ...
   flop_unq3  sc_addr_reg 
     (.dout(sc_addr),	.din({tdi, sc_addr[30:1]}),
   ...
   logic [15:0] sc_data;
   logic [15:0] sc_data_nxt;
   assign 			     sc_data_nxt = (sc_cfg_data_capture_dr) ? 
						    sc_data_rd : {tdi, sc_data[15:1]};
