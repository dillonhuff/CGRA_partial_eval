...
//	
//
//  Source file: /Users/dillon/VerilogWorkspace/CGRAGenerator/hardware/generator_z/pe_new/pe/rtl/test_pe.svp
...
always_comb begin
    case (cfg_a)
        8'hD0 : read_data = op_b_reg;
        8'hD1 : read_data = op_b_reg;
        8'hD2 : read_data = op_b_reg;
        ...
        8'hFE : read_data = inp_code;
        8'hFF : read_data = op_code;
