...
//	
//
//  Source file: /Users/dillon/VerilogWorkspace/CGRAGenerator/hardware/generator_z/jtag/jtag.svp
...
// SYSCLK_CFG_BUS_WIDTH (_GENESIS2_DECLARATION_PRIORITY_) = 16
//
// SYSCLK_CFG_ADDR_WIDTH (_GENESIS2_DECLARATION_PRIORITY_) = 31
//
// SYSCLK_CFG_OPCODE_WIDTH (_GENESIS2_DECLARATION_PRIORITY_) = 5
//
...
//	  { bsr=>no, direction=>in, name=>config_data_from_gc, orientation=>right, pad=>digital, width=>16 },
//	  { bsr=>no, direction=>out, name=>config_data_to_gc, orientation=>right, pad=>digital, width=>16 },
//	  { bsr=>no, direction=>out, name=>config_addr_to_gc, orientation=>right, pad=>digital, width=>36 }
//	]
//
...
module jtag_unq1
  (
   ...
   assign ifc.config_addr_to_gc = {sc_jtag2gc_ifc.cfgOut.op,
                               sc_jtag2gc_ifc.cfgOut.addr};
